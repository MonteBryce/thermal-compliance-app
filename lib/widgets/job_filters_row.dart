/// Job Dashboard Filters Row
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class JobFiltersRow extends StatefulWidget {
  ...
  @override
  State<JobFiltersRow> createState() => _JobFiltersRowState();
}

class _JobFiltersRowState extends State<JobFiltersRow> {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildFilterDropdown(
              label: 'Project Type',
              value: widget.selectedProject ?? _projectOptions[0],
